 ...
 */
public class HermiteGeschlossen implements HermiteCurve
{
	...
	public HermiteGeschlossen(Punkte punkte)
	{
		construct(punkte);
	}
	...
	private void construct(Punkte punkte)
	{
		...
		if (n > 2)
		{
			 ...
			 * S. 23) Hier ist es ein geschlossener Spline => erster Punkt wird als letzter
			 * Punkte gesehen => erste Zeile der Matrix wie bei Mittellpunktformel
			 */
			 ...
			 * S. 23) Hier ist es ein geschlossener Spline => erster Punkt wird als letzter
			 * Punkte gesehen => letzte Zeile der Matrix wie bei Mittellpunktformel
			 */
			matrixA[n - 1][n - 2] = 1;
			matrixA[n - 1][n - 1] = 4;
			matrixA[n - 1][0] = 1;
